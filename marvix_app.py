...
def connect_db():
    client = pymongo.MongoClient(
      st.secrets["mongo"]["mongodb+srv://marvixoct2023:marvix2023@cluster0.inoq6px.mongodb.net/?retryWrites=true&w=majority"], 
...
if st.session_state.username == '':  # User is not logged in
   login_form = st.sidebar.form(...) # Pass the form to st.sidebar
...
if st.session_state.username == "" and st.session_state.form != 'signup_form':
   signup_request = st.sidebar.button('Create Account', 
    on_click=select_signup)
